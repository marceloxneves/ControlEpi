...
namespace TitansMVC.Models
{
    public class SetorModel
    {
        ...
        public ICollection<EpiSetorModel> Epis { get; set; }
        ...
        public ICollection<UniformeSetorModel> Uniformes { get; set; }
        public SetorModel()
        {
            Epis = new List<EpiSetorModel>();
            Uniformes = new List<UniformeSetorModel>();
        }
